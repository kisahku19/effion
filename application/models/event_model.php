...
class Event_model extends CI_Model{
    ...
    function get_all_event(){
        $this->db->select('event.id_event, event.id_admin, admin.nama_admin, event.nama_event,event.tanggal as tanggal, event.isi_event, event.gambar,kategori.nama_kategori,event.id_kategori,(select count(*) from komentar_forum kf where kf.id_forum = event.id_forum) as komen');
        $this->db->from('event');
