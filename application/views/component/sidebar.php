...
<div class="sidebar-category sidebar-category-visible">
						...
						<ul class="navigation navigation-main navigation-accordion">
							...
							<li <?= ($data['uri'] == 'anggota' ? 'class="project"' : '')?>><a href="<?=base_url();?>project"><i class="icon-archive"></i><span>Proyek</span></a></li>
							<li <?= ($data['uri'] == 'anggota' ? 'class="training"' : '')?>><a href="<?=base_url();?>training"><i class="icon-lifebuoy"></i><span>Pelatihan</span></a></li>
