...
<script type="text/javascript">
    $(function() {
        ...
        var ta = $("#table-project").DataTable({
        ...
        $(document).on('click', '.hapus-project', function() {
            var id = $(this).attr('id');
            if (confirm('Anda yakin ingin menghapus project')) {
                $.ajax({
                    url: '<?= base_url() ?>project/hapus_project_ajax/' + id,
                    type: 'POST',
                    dataType: 'json',
        ...
        $(document).on('click', '.hapus-komentar', function() {
            ...
            if (confirm('Anda yakin ingin menghapus komentar')) {
                $.ajax({
                    url: '<?= base_url() ?>project/hapus_komentar_ajax/' + id,
                    type: 'POST',
                    dataType: 'json',
                    success: function(data) {
                        alert(data.pesan);
