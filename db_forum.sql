...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 05, 2020 at 08:00 AM
...
(26, 'holy', 'holy@gmail.com', '081234567892', 'jkt', 'holy', 'ff0eca571f7670efa4ac4a2c37214c6b', 'logoup.png');
...
(9, 0, 1, 2, 'Indonesia Esports League 2019, Kompetisi Esports Resmi Antar Kampus di Indonesia', '<h3>Untuk sementara ini, ada dua&nbsp;<em>game</em>&nbsp;yang akan diperlombakan yaitu&nbsp;Dota 2&nbsp;dan&nbsp;Mobile Legends.&nbsp;</h3><p>Pesertanya sendiri juga masih terbatas untuk beberapa kampus di Indonesia yang hanya mendapatkan&nbsp;<em>invitational</em>. Ada 12 kampus yang telah terpilih sebagai peserta&nbsp;IEL&nbsp;University Series Season 1, mereka adalah :</p><p>Universitas Bina Nusantara</p><p>Universitas Tarumanegara</p><p>Universitas Trisakti</p><p>Universitas Indonesia</p><p>Universitas Bunda Mulia</p><p>Universitas Multimedia Nusantara</p><p>Universitas Kristen Maranantha</p><p>Universitas Kristen Petra Surabaya</p><p>Universitas Dian Nuswantara Semarang</p><p>Universitas Pembangunan Negeri Jawa Timur</p><p>Universitas Ciputra Surabaya</p><p>Universitas Gajah Mada Yogyakarta</p><p>Dari 12 Kampus diatas akan disaring perwakilan dari masing-masing universitas. Untuk mendaftar atau mengikuti kompetisi tersebut juga ada syarat mutlak yang harus diikuti. Yang diperbolehkan mengikuti kompetisi tersebut mahasiswa yang masih berstatus “aktif” di masing-masing kampus serta belum&nbsp;lulus/wisuda.&nbsp;</p>', '2019-02-01', 'e-sport11.jpg', 0),
(10, 0, 1, 3, 'Lomba Video Parodi Program Trans7', '<h3><span class=\"wysiwyg-color-black\"><b>Hai,, mau hadiah total 10 JUTA RUPIAH!!</b></span></h3><br><span class=\"wysiwyg-color-black\"><b>Biaya Pendaftaran&nbsp;</b></span><a rel=\"nofollow\" target=\"_blank\" href=\"https://lomba-video.blogspot.com/\"><span class=\"wysiwyg-color-black\"><b>Lomba Video 2020</b></span></a><br><blockquote><span class=\"wysiwyg-color-black\"><b>Tidak dipungut biaya?ya Dong</b></span></blockquote><span class=\"wysiwyg-color-black\"><b>Informasi Lebih Lanjut&nbsp;</b></span><a rel=\"nofollow\" target=\"_blank\" href=\"https://lomba-video.blogspot.com/\"><span class=\"wysiwyg-color-black\"><b>Lomba Video 2020</b></span></a><br><blockquote><a rel=\"nofollow\" target=\"_blank\" href=\"https://www.instagram.com/p/B6zZYT7DdHk/\"><span class=\"wysiwyg-color-black\"><b>https://www.instagram.com/p/B6zZYT7DdHk/</b></span></a></blockquote>', '2020-01-11', 'videograf11.jpg', 0),
(11, 0, 1, 4, 'Festival Musik Megamic', '<h3>nih ada festival band megamic 2019 stand up for your music !!</h3><br><b>waktu deadline:&nbsp;</b>pendaftaran online sd 11 maret 2019<br><br><b>hadiah yg bisa kamu dapat:</b>&nbsp;seperti tercantum<br><br><b>syarat n ketentuan:</b>&nbsp;biaya pendaftaran rp 150k<br><br>ini lomba utk pelajar sma dan smk utk pelajar se kota semarang<br><br><b>cara ikut:&nbsp;</b>&nbsp; lihat posternya ya.<br><br>bisa hubungi kontak yg tertera<br>yuk nih yg mau ikutan&nbsp;<a rel=\"nofollow\" target=\"_blank\" href=\"http://www.lombaapasaja.com/2017/11/lomba-menyanyi-online.html\">dah buruan</a>', '2019-02-02', 'festival_musik_2019.jpg', 0),
(13, 0, 1, 5, 'STIBAJRA TECHNOLOGY COMPETITION ', '<h3>STIBAJRA TECHNOLOGY COMPETITION 2019 kali ini bertemakan “Get Ready For Industry Revolution 4.0 ”.</h3><blockquote><br></blockquote><b>More Info:</b><br>Email : stibajratech@gmail.com<br>Instagram : @stcstibajraa &amp; @osisstibajra<br>', '2019-09-09', 'STIBAJRA-Technology-Competition-20192.jpg', 0),
(15, 0, 1, 4, 'sk', 'skk', '2020-03-02', '', 0);
...
(4, 'holy', 4, '<p>setuju bgt</p>', '2020-03-01 15:06:00', 1, 0),
(5, 'holy', 8, '<p>mau ikutan ey</p>', '2020-03-01 15:07:18', 0, 0),
(7, 'holy', 9, '<p>mau bgt</p>', '2020-03-01 15:08:35', 0, 1);
...
(5, 'holy', 5, '<p>kurang setuju</p>', '2020-03-01 15:08:59', 4, 1),
(6, 'holy', 5, '<p>dalam hal editing kurang</p>', '2020-03-01 15:09:15', 0, 0);
...
(5, 1, 'Rima Hadi Ismail', '2019-05-30', '<h3>Cara jahit gorden smokering | membuat gorden smokering sendiri dari bahan lokal.</h3><br>Di video kali ini saya perlihatkan bagai mana cara membuat gorden smokering sendiri dari bahan lokal.\r\n\r\n<a rel=\"nofollow\" target=\"_blank\" href=\"https://www.youtube.com/results?search_query=%23fadilahjayagorden\">#fadilahjayagorden</a><br>', 'https://youtube.com/embed/BV52ubJabFg', 0);
...
(6, 11, 'dde', '2019-07-17', '<p>serem nonton ya seru abis</p>', 'https://youtube.com/embed/3Rbj-l20bpo'),
...
(14, 26, 'portfolioku', '2020-03-01', '<p>editing video menggunakan filmora</p>', 'https://www.youtube.com/embed/Q3GhMdu9LkA&t=3095s');
...
--
ALTER TABLE `komentar_event`
  MODIFY `id_komentar_event` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `komentar_project`
--
ALTER TABLE `komentar_project`
  MODIFY `id_komentar_project` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `rating_event`
  MODIFY `id_ratingevent` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `rating_project`
--
ALTER TABLE `rating_project`
  MODIFY `id_ratingproject` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `rating_training`
--
ALTER TABLE `rating_training`
  MODIFY `id_ratingtraining` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
